...
//              steps{
//
//                 git credentialsId: 'GIT_HUB_CREDS', url: 'https://github.com/jitin03/qastack-rest.git'
//              }
//          }
        stage('Pre Test') {
            steps {
        ...
        stage("Docker build"){
            ...
            // sh 'docker run -d -e DB_USER=$DB_USER -e DB_PASSWD=$DB_PASSWD -e DB_ADDR=$DB_ADDR -e DB_NAME=$DB_NAME -p 8090:8090 stack-rest'
            }
        }
    ...
    stage("Push Image to Docker Hub"){
        ...
        sh 'docker login -u mehuljitin -p $PASSWORD'
            ...
            sh 'docker push  mehuljitin/stack-rest:stack-rest'
            }
        }
    }
